...
namespace VideoplayerPlugin
{
    ...
    * @warning Don't interfer with the stream itself if you don't know what you're doing. (e.g. close, seeks etc might cause infinite loops or the video might be closed already) Instead queue those events and apply those actions in the next frame.
    */
    struct IVideoplayerEventListener
    {
        ...
        */
        ...
        /**
        * @brief A seek occured (manual, automatic because of loop or bad performance > sync with timesource)
        */
    ...
    /**
    * @ingroup vp_interface
    * @brief Timesource interface for video and audioplayer classes and also for synchronization targets.
    */
    struct IMediaTimesource
    {
        ...
        */
        ...
        /**
        * @brief stream position (-1 if not avaible)
        * @return position in seconds
        */
        virtual float GetPosition() = 0;

        /**
        * @brief stream duration (-1 if not avaible)
        * @return duration in seconds
        */
        virtual float GetDuration() = 0;

        /**
        * @brief stream end position (-1 if not avaible)
    ...
    */
    struct IMediaPlayback : public IMediaTimesource
    {
        ...
        * This parameter is only avaible if the video is not syncronized to sound timesources,
        ...
        */
        ...
        /**
        * @brief Closes the currently openend media
        */
    ...
    /**
    * @ingroup vp_interface
    * @brief Soundplayback specific interface
    ...
    */
    ...
    {
        /**
        * @brief Opens a soundfile/event.
        * This function wont directly open the sound. The sound will only be opened if the soundplayer is in playing state and at least one
        * soundproxy is present or the 2D sound is set. On each frame there is a retry to open/resume the sound.
        * @param sSoundOrEvent Path to sound in filesystem/pak or the fmod soundevent.
        ...
        * @param nSoundFlags Flags for Fmod, the flags might be modified by the soundplayer. Default is 3D,
        * @param fVolume Volume the sound should be played at. Default is 1
        * @param fMinRadius Minimal radius the sound should be heared from. Default is 0.
        * @param fMaxRadius Maximum radius the sound should be heared at. Default is 100.
        ...
        */
        ...
        /**
        * @brief Removes the Soundproxy of the specific entity
        */
        virtual void RemoveSoundProxy( IEntity* pEntity ) = 0;

        /**
        * @brief Set the 2d Mode of the sound
        * 2D Mode doesn't rely on soundproxies
    ...
    /**
    * @ingroup vp_interface
    * @brief Videoplayback specific interface
    * This is an wrapper to provide a more reliable way to play a sound
    * that can be synchronized to a video.
    */
    struct IVideoplayer : public IMediaPlayback
    {
        ...
        */
        ...
        /**
        * @brief Set timesource for media
        * @param eTS timesource mode
        */
        ...
        * @warning This function is noramlly called automatically
        */
        virtual void Advance( float deltaTime ) = 0;

        /**
        * @brief Get Soundplayer interface
        * @return Interface to current soundplayer interface, NULL if not present
        */
        ...
        */
        ...
        /**
        * @brief Get rendertarget interface
        * @return Interface to current rendertarget/texture interface, NULL if not present
        */
        ...
        * @param item Interfacepointer of listener
        */
    ...
    * @warning Changes require recompilation of the plugin link library. (ABI incompatiblities)
    */
    ...
    */
    struct IVideoplayerSystem : public ICryUnknown
    {
        ...
        * @return Videoplayerinterface of the class
        */
        virtual IVideoplayer* CreateVideoplayer() = 0;

        /**
        * @brief Get videoplayerinterface from an unique video identifier.
        ...
        * @param pVideoplayer interface pointer of the videoplayerclass to be deleted.
        */
        ...
        * This is required for restoring materials to their orginal state.
        * @param mat Material to be remembered
        */
        virtual void RememberMaterial( IMaterial* mat ) = 0;

        /**
        * @brief Restore a cached material to their orginal state.
        * @return success
        ...
        * @param sMaterial Materialname
        * @param nMtlFlags Materialflags (can be override by the videoplayer plugin)
        */
        ...
        * @return success
        * @param pVideo Video to be shown
        * @param pMaterial Material to be overriden
        * @param nSubmat Submaterialslot to be overriden
        * @param nTextureslot Textureslot to be overriden
        ...
        * @param nSubmat Submaterialslot to be restored
        * @param bResetOverride also remove the modified material
        * @see RestoreMaterial
        * @attention Resets all overrides in this material (e.g. videos on different texture slots need to be restored manually)
        */
        ...
        /**
        * @brief Restore all cached materials overriden by the video to their orginal state.
